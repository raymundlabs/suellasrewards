       ...
       body: SingleChildScrollView(
        child: Container(
          ...
          child: Container(
            ...
            // CustomAppBar(fem: fem, ffem: ffem),
            Rectangle39384(fem: fem, ffem: ffem), // Assuming Rectangle39384 is the content you want to display
               ],
              ),
            ),
          ),
...
class Rectangle39384 extends StatelessWidget {
  ...
  const Rectangle39384({required this.fem, required this.ffem});
...
///This is where to change teh reward points
                      Positioned(
