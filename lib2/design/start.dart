...
class _StartScreenState extends State<StartScreen> {
  ...
  void initState() {
    super.initState();
    _loadSavedCredentials(context);
  }

  void _loadSavedCredentials(BuildContext context) async {
            ...
            children: [
              Container(
                margin: EdgeInsets.fromLTRB(
                    0 * fem, 100 * fem, 12.79 * fem, 51 * fem),
                width: 204 * fem,
                height: 80 * fem,
                child: Image.asset(
              ...
              Container(
                margin:
                    EdgeInsets.fromLTRB(7.65 * fem, 0 * fem, 0 * fem, 34 * fem),
                width: 298.45 * fem,
                height: 257 * fem,
                child: Image.asset(
              ...
              Container(
                margin: EdgeInsets.fromLTRB(
                    26.07 * fem, 0 * fem, 27.86 * fem, 21 * fem),
                width: double.infinity,
                height: 96 * fem,
                child: Center(
                  child: SizedBox(
              ...
              GestureDetector(
                ...
                child: Container(
                  margin: EdgeInsets.fromLTRB(
                      36.07 * fem, 0 * fem, 45.86 * fem, 36 * fem),
                  width: double.infinity,
                  height: 60 * fem,
              ...
              Container(
                margin: EdgeInsets.fromLTRB(
                    10.07 * fem, 0 * fem, 22.86 * fem, 0 * fem),
                width: double.infinity,
                child: Row(
                  mainAxisAlignment: MainAxisAlignment.center,
                  crossAxisAlignment: CrossAxisAlignment.center,
