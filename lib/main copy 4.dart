...
class _AuthScreenState extends State<AuthScreen> {
  ...
  Future<void> _signOut() async {
    final response = await http.get(Uri.parse('https://app.suellastheshoelaundry.com/admin/auth/logout'));

    if (response.statusCode == 200) {
      // Clear any user data or authentication tokens on the client side
      // ...

      // Navigate back to the main screen
      Navigator.of(context).popUntil((route) => route.isFirst); // Pop all routes until main.dart
    } else {
