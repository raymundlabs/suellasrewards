...
class _AuthScreenState extends State<AuthScreen> {
  ...
  void _fetchCsrfToken() async {
    final response = await http.get(Uri.parse('https://app.suellastheshoelaundry.com/home/get_csrf_token_nxtri04tgx'));
    if (response.statusCode == 200) {
      final data = json.decode(response.body);
      setState(() {
        _csrfToken = data['token_hash'];
      });
    } else {
      // Handle error
    }
  ...
  void _submit() async {
    ...
    try {
      ...
      final response = await http.post(
        Uri.parse('https://app.suellastheshoelaundry/admin/auth/login_app'), // Change this URL accordingly
        headers: headers,
