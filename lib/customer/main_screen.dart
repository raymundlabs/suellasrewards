...
class _MainScreenState extends State<MainScreen> with SingleTickerProviderStateMixin {
    ...
    return Scaffold(
      ...
      body: SingleChildScrollView(
        child: Column(
          children: [
            Container(
              // ... (green container's content)
            ),
            SizedBox(height: 20 * fem), // Add spacing between the containers
            Container(
              // ... (blue container's content)
            ),
            SizedBox(height: 20 * fem), // Add spacing between the containers
            Container(
              padding: EdgeInsets.all(20 * fem),
              width: double.infinity,
              height: 500 * fem, // Use the same height as the containers
              child: TabBarView(
  ...
  children: [
    ...
    Container(
      ...
      child: Text('Content for READ Tab'),
    ),
    
    // Content for "NEW" tab
    Container(
      alignment: Alignment.center,
      child: Text('Content for NEW Tab'),
    ),
  ],
),
    ...
    return Container(
      ...
      child: Row(
        ...
        children: [
          GestureDetector(
            onTap: () {
              // Implement the behavior for this icon's action
            },
            child: Padding(
